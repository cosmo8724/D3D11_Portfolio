#include "stdafx.h"
#include "..\Public\Hat_ToothyHood.h"
#include "GameInstance.h"
#include "Sigrid.h"
#include "Bone.h"

CHat_ToothyHood::CHat_ToothyHood(DEVICE pDevice, DEVICE_CONTEXT pContext)
	: CGameObject(pDevice, pContext)
{
}

CHat_ToothyHood::CHat_ToothyHood(const CHat_ToothyHood & rhs)
	: CGameObject(rhs)
{
}

HRESULT CHat_ToothyHood::Initialize_Prototype()
{
	m_bHasModel = true;
...
HRESULT CHat_ToothyHood::Initialize(const wstring & wstrPrototypeTag, void * pArg)
{
	HATDESC	HatDesc;
...
void CHat_ToothyHood::Tick(_double dTimeDelta)
{
	__super::Tick(dTimeDelta);
}

void CHat_ToothyHood::Late_Tick(_double dTimeDelta)
{
...
HRESULT CHat_ToothyHood::Render()
{
...
HRESULT CHat_ToothyHood::Render_ShadowDepth()
{
...
HRESULT CHat_ToothyHood::Render_Reflect()
{
...
void CHat_ToothyHood::ImGui_RenderProperty()
{
}

HRESULT CHat_ToothyHood::SetUp_Component()
{
	...
	FAILED_CHECK_RETURN(__super::Add_Component(LEVEL_TESTSTAGE, L"Prototype_Component_Model_Hat_ToothyHood", L"Com_Model", (CComponent**)&m_pModelCom, this), E_FAIL);

	return S_OK;
}

HRESULT CHat_ToothyHood::SetUp_ShaderResource()
{
...
HRESULT CHat_ToothyHood::SetUp_ShaderResource_LightDepth()
{
	NULL_CHECK_RETURN(m_pShaderCom, E_FAIL);
...
HRESULT CHat_ToothyHood::SetUp_ShaderResource_Reflect()
{
	NULL_CHECK_RETURN(m_pShaderCom, E_FAIL);
...
CHat_ToothyHood * CHat_ToothyHood::Create(DEVICE pDevice, DEVICE_CONTEXT pContext)
{
	CHat_ToothyHood*		pInstance = new CHat_ToothyHood(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CHat_ToothyHood");
...
CGameObject * CHat_ToothyHood::Clone(const wstring & wstrPrototypeTag, void * pArg)
{
	CHat_ToothyHood*		pInstance = new CHat_ToothyHood(*this);

	if (FAILED(pInstance->Initialize(wstrPrototypeTag, pArg)))
	{
		MSG_BOX("Failed to Clone : CHat_ToothyHood");
		Safe_Release(pInstance);
	}
