#include "stdafx.h"
#include "..\Public\Shop_ButtonS.h"
#include "GameInstance.h"
#include "GameUtility.h"
#include "Cursor.h"
#include "Shop_BackGround.h"

CShop_ButtonS::CShop_ButtonS(DEVICE pDevice, DEVICE_CONTEXT pContext)
	: CUI(pDevice, pContext)
{
}

CShop_ButtonS::CShop_ButtonS(const CShop_ButtonS & rhs)
	: CUI(rhs)
{
}

HRESULT CShop_ButtonS::Initialize_Prototype()
{
	m_wstrUITag = L"UI_Shop_ButtonS";
...
HRESULT CShop_ButtonS::Initialize(const wstring & wstrPrototypeTag, void * pArg)
{
...
void CShop_ButtonS::Tick(_double dTimeDelta)
{
	...
	if (CGameInstance::GetInstance()->Key_Pressing(DIK_S) || m_bMouseHover == true)
	{
...
void CShop_ButtonS::Late_Tick(_double dTimeDelta)
{
...
void CShop_ButtonS::ImGui_RenderProperty()
{
}

HRESULT CShop_ButtonS::SetUp_Component()
{
	...
	FAILED_CHECK_RETURN(__super::Add_Component(LEVEL_TESTSTAGE, L"Prototype_Component_Texture_UI_Shop_ButtonS", L"Com_Texture", (CComponent**)&m_pTextureCom, this), E_FAIL);

	return S_OK;
}

HRESULT CShop_ButtonS::SetUp_ShaderResources()
{
...
CShop_ButtonS * CShop_ButtonS::Create(DEVICE pDevice, DEVICE_CONTEXT pContext)
{
	CShop_ButtonS*	pInstance = new CShop_ButtonS(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CShop_ButtonS");
...
CGameObject * CShop_ButtonS::Clone(const wstring & wstrPrototypeTag, void * pArg)
{
	CShop_ButtonS*	pInstance = new CShop_ButtonS(*this);
