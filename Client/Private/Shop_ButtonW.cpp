#include "stdafx.h"
#include "..\Public\Shop_ButtonW.h"
#include "GameInstance.h"
#include "GameUtility.h"
#include "Cursor.h"
#include "Shop_BackGround.h"

CShop_ButtonW::CShop_ButtonW(DEVICE pDevice, DEVICE_CONTEXT pContext)
	: CUI(pDevice, pContext)
{
}

CShop_ButtonW::CShop_ButtonW(const CShop_ButtonW & rhs)
	: CUI(rhs)
{
}

HRESULT CShop_ButtonW::Initialize_Prototype()
{
	m_wstrUITag = L"UI_Shop_ButtonW";
...
HRESULT CShop_ButtonW::Initialize(const wstring & wstrPrototypeTag, void * pArg)
{
...
void CShop_ButtonW::Tick(_double dTimeDelta)
{
	...
	if (CGameInstance::GetInstance()->Key_Pressing(DIK_W) || m_bMouseHover == true)
	{
...
void CShop_ButtonW::Late_Tick(_double dTimeDelta)
{
...
void CShop_ButtonW::ImGui_RenderProperty()
{
}

HRESULT CShop_ButtonW::SetUp_Component()
{
	...
	FAILED_CHECK_RETURN(__super::Add_Component(LEVEL_TESTSTAGE, L"Prototype_Component_Texture_UI_Shop_ButtonW", L"Com_Texture", (CComponent**)&m_pTextureCom, this), E_FAIL);

	return S_OK;
}

HRESULT CShop_ButtonW::SetUp_ShaderResources()
{
...
CShop_ButtonW * CShop_ButtonW::Create(DEVICE pDevice, DEVICE_CONTEXT pContext)
{
	CShop_ButtonW*	pInstance = new CShop_ButtonW(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CShop_ButtonW");
...
CGameObject * CShop_ButtonW::Clone(const wstring & wstrPrototypeTag, void * pArg)
{
	CShop_ButtonW*	pInstance = new CShop_ButtonW(*this);
