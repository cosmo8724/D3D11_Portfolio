#include "stdafx.h"
#include "..\Public\Talk_Button2.h"
#include "GameInstance.h"
#include "Talk_NPC_Background.h"

CTalk_Button2::CTalk_Button2(DEVICE pDevice, DEVICE_CONTEXT pContext)
	: CUI(pDevice, pContext)
{
}

CTalk_Button2::CTalk_Button2(const CTalk_Button2 & rhs)
	: CUI(rhs)
{
}

HRESULT CTalk_Button2::Initialize_Prototype()
{
	m_wstrUITag = L"UI_Talk_Button2";
...
HRESULT CTalk_Button2::Initialize(const wstring & wstrPrototypeTag, void * pArg)
{
...
void CTalk_Button2::Tick(_double dTimeDelta)
{
	...
	if (CGameInstance::GetInstance()->Key_Pressing(DIK_2))
	{
...
void CTalk_Button2::Late_Tick(_double dTimeDelta)
{
...
void CTalk_Button2::ImGui_RenderProperty()
{
}

HRESULT CTalk_Button2::SetUp_Component()
{
...
HRESULT CTalk_Button2::SetUp_ShaderResources()
{
...
CTalk_Button2 * CTalk_Button2::Create(DEVICE pDevice, DEVICE_CONTEXT pContext)
{
	CTalk_Button2*	pInstance = new CTalk_Button2(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CTalk_Button2");
...
CGameObject * CTalk_Button2::Clone(const wstring & wstrPrototypeTag, void * pArg)
{
	CTalk_Button2*	pInstance = new CTalk_Button2(*this);
