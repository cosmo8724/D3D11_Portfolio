...
CVIBuffer_Cell::CVIBuffer_Cell(DEVICE pDevice, DEVICE_CONTEXT pContext)
...
HRESULT CVIBuffer_Cell::Initialize(CGameObject * pOwner, void * pArg)
{
...
CVIBuffer_Cell * CVIBuffer_Cell::Create(DEVICE pDevice, DEVICE_CONTEXT pContext, const _float3 * pPoints)
{
