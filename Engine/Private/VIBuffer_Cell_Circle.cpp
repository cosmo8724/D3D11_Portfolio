...
CVIBuffer_Cell_Circle::CVIBuffer_Cell_Circle(DEVICE pDevice, DEVICE_CONTEXT pContext)
...
HRESULT CVIBuffer_Cell_Circle::Initialize(CGameObject * pOwner, void * pArg)
{
...
CVIBuffer_Cell_Circle * CVIBuffer_Cell_Circle::Create(DEVICE pDevice, DEVICE_CONTEXT pContext, const _float3 & vPoint)
{
